...
- [x] 1.1 Unit tests for ArtistWatch model and Event types
...
- [x] 1.2 Unit tests for EventsProvider interface and MockProvider
...
- [x] 1.3 Implement ArtistWatch model and Event types
...
- [x] 1.4 Implement EventsProvider interface and MockProvider
...
- [x] 2.1 Unit tests for ArtistWatch repository methods
...
- [x] 2.2 Unit tests for ArtistWatchService and EventsService
...
- [x] 2.3 Unit tests for events and watch HTTP handlers
...
- [x] 2.4 Implement ArtistWatch repository methods
...
- [x] 2.5 Implement ArtistWatchService and EventsService
...
- [x] 2.6 Implement events and watch HTTP handlers + wire routes
...
- [x] 3.1 Unit tests for artist watch and events API clients and hooks
...
- [x] 3.2 Implement frontend types, API clients, and hooks
...
- [x] 4.1 Unit tests for WatchButton, EventCard, and ArtistEventsSection components
...
- [x] 4.2 Unit tests for My Shows page
...
- [x] 4.3 Implement WatchButton, EventCard, and ArtistEventsSection components
...
- [x] 4.4 Implement My Shows page and integrate into existing pages
...
- [x] 5.1 Build validation and contract alignment
