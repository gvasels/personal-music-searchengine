...
- [ ] 1. Create frontend S3 bucket infrastructure
...
- [ ] 2. Create frontend CloudFront distribution
...
- [ ] 3. Add security headers response policy
...
- [ ] 4. Create S3 bucket policy for CloudFront OAC
...
- [ ] 5. Create frontend infrastructure main.tf
...
- [ ] 6. Create GitHub Actions OIDC provider in global infrastructure
...
- [ ] 7. Add deploy permissions to GitHub Actions IAM role
...
- [ ] 8. Create CI workflow for PR checks
...
- [ ] 9. Create deploy workflow for main branch
...
- [ ] 10. Add backend Docker build and ECR push to deploy workflow
...
- [ ] 11. Create CLAUDE.md for infrastructure/frontend
...
- [ ] 12. Update root CLAUDE.md with Epic 6 completion
  - File: `CLAUDE.md` (root)
...
- [ ] 14. Update CHANGELOG.md with Epic 6
  - File: `CHANGELOG.md`
...
- [ ] 15. Update epics-user-stories.md to mark Epic 6 complete
