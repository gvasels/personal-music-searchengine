...
# ECR Repository for Upload Processor Lambda
...
# ECR Repository for Search Indexer Lambda
...
# ECR Repository for Nixiesearch Lambda (embedded search engine)
resource "aws_ecr_repository" "nixiesearch" {
